            ...
            body: Row(
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  width: _sidebarExpanded ? 236 : 0,
                  child: IgnorePointer(
                    ignoring: !_sidebarExpanded,
                    child: Padding(
                      padding:
                      ...
                      child: MouseRegion(
                        ...
                        child: DecoratedBox(
                          decoration: BoxDecoration(
                            color:
                                isDark ? const Color(0xFF060F26) : Colors.white,
                            borderRadius: BorderRadius.circular(18),
                            border: Border.all(
                              color: isDark
                                  ? const Color(0xFF1C2C5A)
                          ...
                          child: ClipRRect(
                            ...
                            child: NavigationRail(
                              ...
                              unselectedLabelTextStyle: TextStyle(
                                color: isDark
                                    ? const Color(0xFF8BA0D7)
                                    : const Color(0xFF5A678A),
                              ),
                ...
                if (_sidebarExpanded) const SizedBox(width: 10),
                Expanded(
                  child: _isLoading
                      ? const LoadingState()
                      : Column(
