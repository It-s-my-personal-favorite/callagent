...
class _CustomerProfilePageState extends State<CustomerProfilePage> {
  ...
  Future<void> _reloadCalls() async {
    ...
    setState(() {
      _calls = updated;
      if (_selectedCallId == null || _calls.every((c) => c.id != _selectedCallId)) {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = _selectedCall;
    return Scaffold(
      backgroundColor: isDark ? const Color(0xFF040A1D) : const Color(0xFFF7F9FF),
      body: DecoratedBox(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isDark
                ? const [Color(0xFF040A1D), Color(0xFF0A1534)]
              ...
              child: Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: isDark ? const Color(0xFF1B2E5D) : const Color(0xFFD8E2FB),
                    ),
                  ),
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: selected == null
                            ? const Center(
                                child: Text('Keine Telefonate für diese Nummer vorhanden'),
                              )
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: isDark ? const Color(0xFF9CB0E6) : const Color(0xFF6073A8),
                    fontSize: 12,
                  ),
                ),
              ],
  ...
  Widget _buildStats(bool isDark) {
    return Wrap(
      ...
      children: [
        ...
        _statCard('Ø Dauer', _formatDuration(_avgDurationSec), Icons.timer, isDark),
  ...
  Widget _buildCallsTab(CallSession selected, bool isDark) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final detailPanel = _buildCallDetailPanel(isDark, selected, transcript, notes);
        if (stacked) {
          return Column(
            children: [
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(value: 'duration', child: Text('Dauer hoch -> niedrig')),
                    DropdownMenuItem(value: 'latency', child: Text('Latenz hoch -> niedrig')),
                    DropdownMenuItem(value: 'tokens', child: Text('Tokens hoch -> niedrig')),
                  ],
                  onChanged: (value) {
            ...
            children: [
              Expanded(
                child: SwitchListTile(
                  ...
                  title: const Text('Nur markierte', style: TextStyle(fontSize: 12)),
                ),
              ),
            ],
          ),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: selectedItem
                          ...
                          : (isDark ? const Color(0xFF101E44) : const Color(0xFFF7F9FF)),
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                        color: selectedItem
                            ? const Color(0xFF8D63FF)
                            : (isDark ? const Color(0xFF29417A) : const Color(0xFFD8E2FB)),
                      ),
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _metaPill('Dauer ${_formatDuration(call.durationSec)}', isDark),
                            _metaPill('Tokens ${call.metrics.tokenTotal}', isDark),
                          ],
                        ),
                      ],
                    ),
