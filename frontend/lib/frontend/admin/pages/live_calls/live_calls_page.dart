...
class _LiveCallsPageState extends State<LiveCallsPage> {
      ...
      topToolbar: Wrap(
        ...
        children: [
          _toolbarActionButton(
            ...
            onTap: () => setState(() => _showArchivedCalls = !_showArchivedCalls),
          ),
  ...
  Widget _toolbarActionButton({
    ...
    return OutlinedButton.icon(
      ...
      style: OutlinedButton.styleFrom(
        ...
        foregroundColor: isDark ? const Color(0xFFD8E4FF) : const Color(0xFF142246),
  ...
  Widget _sortDropdown(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final textColor = isDark ? const Color(0xFFD8E4FF) : const Color(0xFF142246);
    return Container(
      width: 220,
      height: 44,
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: isDark
              ? const [Color(0xFF020715), Color(0xFF08112A)]
              : const [Color(0xFFF7F9FF), Color(0xFFEDF2FF)],
        ),
      ),
      child: Column(
        children: [
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final leftPanel = ConstrainedBox(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: isDark ? const Color(0xFF1B2E5D) : const Color(0xFFD8E2FB)),
                    ),
                    child: Column(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: isSelected
                                              ? (isDark ? const Color(0xFF311A67) : const Color(0xFFEAE2FF))
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                ...
                                                if (call.important)
                                                  const Padding(
                                                    ...
                                                    child: Icon(Icons.star, color: Color(0xFFFFC107), size: 18),
                                                  ),
                                                Text(
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                LatencyBadge(ms: call.metrics.avgLatencyMs),
                                              ],
                                            ),
                                            ...
                                            Wrap(
                                              ...
                                              children: [
                                                _MetaPill(
                                                  icon: Icons.schedule,
                                                  label: 'Am ${_formatDateTime(call.startedAt)}',
                                                  isDark: isDark,
                                                ),
                                                _MetaPill(
                                                ...
                                                _MetaPill(
                                                  icon: Icons.token,
                                                  label: '${call.metrics.tokenTotal} Tokens',
                                                  isDark: isDark,
                                                ),
                                              ],
                                            ),
                ...
                final rightPanel = ConstrainedBox(
                  constraints: BoxConstraints(minWidth: rightMinWidth, minHeight: 300),
                  child: Container(
                    ...
                    child: selectedCall == null
                        ...
                        : CallDetailPanel(
                            ...
                            onOpenCustomerPage: () => onOpenCustomerPage(selectedCall!),
                          ),
                  ),
                );
                if (stacked) {
