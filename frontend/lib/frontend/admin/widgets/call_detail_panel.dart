...
class _CallDetailPanelState extends State<CallDetailPanel> {
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text('Live Info öffnen'),
                onTap: () => Navigator.of(ctx).pop('live'),
              ),
              ListTile(
                leading: const Icon(Icons.sticky_note_2_outlined),
                title: const Text('Notizen öffnen'),
                onTap: () => Navigator.of(ctx).pop('notes'),
              ),
              ListTile(
                leading: const Icon(Icons.upload_file_outlined),
                title: const Text('Anruf als PDF exportieren'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(child: _buildTabStrip(isDark)),
          ...
          Wrap(
            ...
            children: [
              Text(
                ...
                'beendet: ${call.endedAt != null ? _formatDateTime(call.endedAt!) : '-'}   '
  ...
  Widget _buildTabStrip(bool isDark) {
    ...
    return Container(
      ...
      child: Wrap(
        ...
        runSpacing: 6,
        children: tabs
            .map((tab) => _tabButton(tab.label, tab.index,
                icon: tab.icon, isDark: isDark))
            .toList(),
      ),
    );
  }
  ...
  Widget _topActionButton(
    ...
    return OutlinedButton.icon(
      ...
      style: OutlinedButton.styleFrom(
        foregroundColor:
            isDestructive ? const Color(0xFFFFE0E6) : const Color(0xFFE0E9FF),
        side: BorderSide(
          color: isActive
              ? const Color(0xFF9B7BFF)
              : (isDestructive
                  ? const Color(0xFFED6A88)
                  : color.withValues(alpha: 0.9)),
        ),
        backgroundColor: isActive
            ? const Color(0xFF3E2A7C)
            : (isDestructive
                ? const Color(0xFF6F223B)
